...
func (p *ProductServer) AddProduct(ctx context.Context, req *pb.AddProductRequest) (*pb.AddProductResponse, error) {
	...
	data, err := p.ProductUseCase.AddProduct(model)
	if err != nil {
...
func (p *ProductServer) UpdateProducts(ctx context.Context, req *pb.UpdateProductRequest) (*pb.UpdateProductResponse, error) {
	...
	updated, err := p.ProductUseCase.UpdateProducts(product)
	if err != nil {
		return nil, err
	}
...
func (p *ProductServer) DeleteProduct(ctx context.Context, req *pb.DeleteProductRequest) (*pb.DeleteProductResponse, error) {

	err := p.ProductUseCase.DeleteProduct(int(req.ID))
	if err != nil {
