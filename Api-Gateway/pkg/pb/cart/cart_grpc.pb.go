...
type CartClient interface {
	...
	DoesCartExist(ctx context.Context, in *DoesCartExistRequest, opts ...grpc.CallOption) (*DoesCartExistResponse, error)
...
func (c *cartClient) DoesCartExist(ctx context.Context, in *DoesCartExistRequest, opts ...grpc.CallOption) (*DoesCartExistResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DoesCartExistResponse)
...
type CartServer interface {
	...
	DoesCartExist(context.Context, *DoesCartExistRequest) (*DoesCartExistResponse, error)
...
func (UnimplementedCartServer) DoesCartExist(context.Context, *DoesCartExistRequest) (*DoesCartExistResponse, error) {
