...
const file_pkg_pb_admin_proto_rawDesc = "" +
	"\n" +
	"\x12pkg/pb/admin.proto\x12\x05admin\"\x80\x01\n" +
	...
	"\x06status\x18\x01 \x01(\x03R\x06status\x127\n" +
	"\fadminDetails\x18\x02 \x01(\v2\x13.admin.AdminDetailsR\fadminDetails\x12\x14\n" +
	"\x05token\x18\x03 \x01(\tR\x05token2\x94\x01\n" +
	"\x05Admin\x12F\n" +
...
var (
	...
	file_pkg_pb_admin_proto_rawDescData []byte
)

func file_pkg_pb_admin_proto_rawDescGZIP() []byte {
	file_pkg_pb_admin_proto_rawDescOnce.Do(func() {
		file_pkg_pb_admin_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_pb_admin_proto_rawDesc), len(file_pkg_pb_admin_proto_rawDesc)))
	})
...
func file_pkg_pb_admin_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_pb_admin_proto_rawDesc), len(file_pkg_pb_admin_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
